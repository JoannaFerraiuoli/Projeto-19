...
mainCyclist.setCollider("mainCyclist",0,0, mainCyclist);
debug = true;
...
function reset(){
  ...
  opponent1.destroyEach(); 
  opponent2.destroyEach();
  opponent3.destroyEach();
  opponent4.destroyEach();
  opponent5.destroyEach(); 
  opponent6.destroyEach();
  opponent7.destroyEach();
  opponent8.destroyEach();
  opponent9.destroyEach();
